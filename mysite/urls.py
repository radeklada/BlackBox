...
urlpatterns = [
    ...
    path("podzial-na-klasy-rownowaznosci", views.podzial_na_klasy_rownowaznosci, name="podzial-na-klasy-rownowaznosci"),
    path("analiza-wartosci-brzegowych", views.analiza_wartosci_brzegowych, name="analiza-wartosci-brzegowych"),
    path("testowanie-w-oparciu-o-tablice-decyzyjna", views.testowanie_w_oparciu_o_tablice_decyzyjna, name="testowanie-w-oparciu-o-tablice-decyzyjna"),
    path("testowanie-przejsc-miedzy-stanami", views.testowanie_przejsc_miedzy_stanami, name="testowanie-przejsc-miedzy-stanami"),
    path("testowanie-oparte-na-przypadkach-uzycia", views.testowanie_oparte_na_przypadkach_uzycia, name="testowanie-oparte-na-przypadkach-uzycia"),
